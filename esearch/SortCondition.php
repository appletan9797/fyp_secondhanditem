...
$id= $_POST["itemID"];
		$sql1 = "SELECT * from testing WHERE (ItemCategory ='$id' AND ItemStatus = 'Available' AND Conditions= 'Used') OR (MeetingPoint='$id' AND ItemStatus = 'Available' AND Conditions= 'Used') ORDER BY Time DESC LIMIT $page1,8 ";
