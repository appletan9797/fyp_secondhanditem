...
if ($page=="" || $page =="1"){ //If the user first come to page or the page is page 1
	...
	$page1=($page*2)-2; //Algorithm. If the page is 2 then the starting index will be 2*8 - 8 = 8, 3*8 - 8 =16 .........
}
?>
...
$sqlCheckNumRow = "SELECT * from testing WHERE ItemCategory = '$id' AND ItemStatus = 'Available'";
