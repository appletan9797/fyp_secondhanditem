...
$id= $_POST["itemID"];
		$sql1 = "SELECT * from testing WHERE (ItemCategory = '$id' AND ItemStatus = 'Available' AND Conditions= 'New') OR (MeetingPoint='$id' AND ItemStatus = 'Available' AND Conditions= 'New') ORDER BY Time DESC LIMIT $page1,8 ";
