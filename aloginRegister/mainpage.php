    ...
    <div class="row" >
        ...
        <div class="col-md-9" style="margin-top:80">
            ...
            <div><a href="#">Men's Fashion</a></div>
			 <?php $sql="SELECT * from testing WHERE ItemCategory='MensFashion' LIMIT 1";
					...
					$data1=$connection->query($selectImage);
											   ...
											   ?>   
                <div class="row" class="col-xs-12 col-md-9">
                    <div class="col-xs-4 col-md-4">
                        <div class="thumbnail">
                            <img src=<?php echo "http://localhost/finalFYP/images/".$image;?> alt="images">
                            <div class="caption">
                                <h4 class="pull-right"><?php echo "RM".$price ?></h4>
                                <?php 
